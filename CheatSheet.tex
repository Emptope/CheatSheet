...
% ALL THE CONTENTS ARE MADE BY Yao Tuo (Emptope)
% Copyleft 2026 Yao Tuo (Emptope), All wrongs reversed.

\documentclass[a4paper]{article}

\input{config/packages.tex}
\input{config/fonts_setup.tex}
\input{config/page_style.tex}
...
行内公式：\m{\mathrm{e}^{i \pi} + 1 = 0}

行间公式：$$\mathrm{e}^{i \pi} + 1 = 0$$
